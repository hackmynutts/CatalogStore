...
namespace CatalogStore.BackendAPI.Migrations
{
    ...
    [Migration("20260923210518_addInventoryLineTBAndProductExternalID")]
    partial class addInventoryLineTBAndProductExternalID
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CatalogStore.BackendAPI.Models.Inventory.Inventory", b =>
                {
                    ...
                    b.ToTable("Inventory_TB", "dbo");
                });

            modelBuilder.Entity("CatalogStore.BackendAPI.Models.InventoryLine.InventoryLine", b =>
                {
                    b.Property<int>("InventoryLineID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("InventoryLineID"));
                    ...
                    b.Property<DateOnly?>("LastRestock")
                        .HasColumnType("date");
                    ...
                    b.Property<int>("QuantityAvailable")
                        ...
                        .HasColumnType("int")
                        .HasComputedColumnSql("[Quantity] - [QuantityOnHold]", true);

                    b.Property<int>("QuantityOnHold")
                        .HasColumnType("int");

                    b.Property<int>("QuantityReorder")
                        .HasColumnType("int");
                    ...
                    b.ToTable("InventoryLine_TB", "dbo", t =>
                        {
            ...
            modelBuilder.Entity("CatalogStore.BackendAPI.Models.Product.Product", b =>
                {
                    ...
                    b.Property<decimal>("PriceCalcIVA")
                        .HasPrecision(10, 2)
                        .HasColumnType("decimal(10,2)");
            ...
            modelBuilder.Entity("CatalogStore.BackendAPI.Models.InventoryLine.InventoryLine", b =>
                {
                    b.HasOne("CatalogStore.BackendAPI.Models.Inventory.Inventory", "Inventory")
                        .WithMany()
